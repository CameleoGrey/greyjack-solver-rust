...
mod tests {
    ...
    fn test_gp_float_var_frozen() {
        let mut x = GPFloatVar::new("x", Some(1.0), -1.0, 1.0, true, None);
    ...
    fn test_gp_float_var_unfrozen() {
        let mut x = GPFloatVar::new("x", Some(1000.0), -10000.0, 10000.0, false, None);
    ...
    fn test_gp_float_var_fix_value() {
        let mut x = GPFloatVar::new("x", Some(1.0), -1.0, 1.0, false, None);
