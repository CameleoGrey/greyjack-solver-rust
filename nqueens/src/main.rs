...
use greysplanner::agents::{GeneticAlgorithm, LateAcceptance};
...
fn main() {
    ...
    let mut nqueens_domain = NQueensDomainBuilder::build_domain(10000, 45);
    ...
    //let agent_builder = GA(GeneticAlgorithm::new(20, 0.0, Some(1.0), 0.1, 0.00001, 1, termination_strategy));
