...
impl ResourceLimits {
    ...
    pub fn check_operation_limit(&self, current_ops: usize) -> super::error::Result<()> {
        if current_ops > self.max_operations_per_batch {
            return Err(super::error::GreynetError::resource_limit(
    ...
    pub fn check_tuple_limit(&self, current_tuples: usize) -> super::error::Result<()> {
