...
use super::utils::TupleUtils;
use super::GreynetFact;
...
impl AnyTuple {
    ...
    pub fn combine(&self, other: &AnyTuple) -> super::Result<AnyTuple> {
        match (self, other) {
            ...
            _ => {
                ...
                if combined_facts.len() > 5 {
                    Err(super::GreynetError::invalid_arity(5, combined_facts.len()))
                } else {
