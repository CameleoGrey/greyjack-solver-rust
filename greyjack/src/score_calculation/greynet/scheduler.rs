...
use super::arena::{NodeArena, SafeTupleIndex, TupleArena, NodeOperation};
use super::state::TupleState;
use super::super::scores::ScoreTrait;
use super::{Result, GreynetError, ResourceLimits};
...
impl BatchScheduler {
    ...
    pub fn execute_all<S: ScoreTrait>(&mut self, nodes: &mut NodeArena<S>, tuples: &mut TupleArena) -> Result<()> {
    ...
    pub fn execute_all_scalar<S: ScoreTrait>(&mut self, nodes: &mut NodeArena<S>, tuples: &mut TupleArena) -> Result<()> {
    ...
    fn prepare_operations<S: ScoreTrait>(&mut self, nodes: &mut NodeArena<S>, tuples: &mut TupleArena) -> Result<Vec<SafeTupleIndex>> {
