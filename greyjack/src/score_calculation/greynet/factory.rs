...
use super::{GreynetFact, constraint::{ConstraintWeights, ConstraintId}, Result, GreynetError, ResourceLimits};
use super::super::scores::ScoreTrait;
use super::session::Session;
use super::scheduler::BatchScheduler;
use super::arena::TupleArena;
use std::any::TypeId;
...
pub struct ConstraintFactory<S: ScoreTrait> {
...
impl<S: ScoreTrait + 'static> ConstraintFactory<S> {
