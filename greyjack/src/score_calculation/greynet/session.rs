...
use super::arena::{NodeArena, NodeData, NodeId, SafeTupleIndex, TupleArena};
use super::constraint::{ConstraintId, ConstraintWeights};
use super::scheduler::BatchScheduler;
use super::super::scores::ScoreTrait;
use super::state::TupleState;
use super::tuple::{AnyTuple, FactIterator, UniTuple, ZeroCopyFacts};
use super::{GreynetError, GreynetFact, ResourceLimits, Result, collectors::BaseCollector};
...
#[derive(Debug, Clone)]
pub struct FactConstraintMatch<S: ScoreTrait> {
...
#[derive(Debug, Clone)]
pub struct FactConstraintReport<S: ScoreTrait> {
...
pub struct SessionStatistics {
    ...
    pub arena_stats: super::arena::ArenaStats,
...
#[derive(Debug)]
pub struct Session<S: ScoreTrait> {
...
impl<S: ScoreTrait + 'static> Session<S> {
