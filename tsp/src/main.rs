...
use persistence::{TSPCotwinBuilder, TSPDomainBuilder, TSPDomainUpdater};
...
fn main() {
    ...
    let mut domain = TSPDomainBuilder::build_domain(file_path);
    let cotwin_builder = TSPCotwinBuilder::new();
    ...
    //let agent_builder = GA(GeneticAlgorithm::new(128, 0.5, Some(1.0), 0.2, 0.00001, 10, termination_strategy));
    ...
    TSPDomainUpdater::update_domain(&mut domain, solution);
