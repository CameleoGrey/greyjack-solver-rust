...
impl CotwinBuilder {
    ...
    fn build_planning_stops<'a>(domain: &TravelSchedule, is_already_initialized: bool) -> Vec<EntityVariants<'a>> {
        ...
        if is_already_initialized {
            panic!("Building cotwin for existing domain isn't already implemented for TSP problem")
        }
